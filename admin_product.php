...
if (isset($_POST['add_product'])) {
    ...
    if (mysqli_num_rows($select_product_name) > 0) {
        ...
        $insert_product = $productManager->addProduct($product_name, $product_quantity, $product_price, $product_detail, $image);
        if ($insert_product) {
...
if (isset($_GET['delete'])) {
    ...
    $select_delete_image = $productManager->getProductById($delete_id);
    $fetch_delete_image = mysqli_fetch_assoc($select_delete_image);
    unlink('img/' . $fetch_delete_image['image']);

    $productManager->deleteProduct($delete_id);
...
if (isset($_POST['update_product'])) {
    ...
    $productManager->updateProduct($update_id, $update_name, $update_quantity, $update_price, $update_detail, $image_new_name);
    header('location:admin_product.php');
}
?>
...
<body>
    ...
    <section class="add-products form-container">
        <h1 class='title' style="margin-top: 20px; color```php
    ...
    <section class="show-products">
        ...
        <div class="box-container" style="margin-top: -10px;">
            <?php
            $select_products = $productManager->getAllProducts();
    ...
    <section class="update-container">
        ...
        if (isset($_GET['edit'])) {
            $edit_id = $_GET['edit'];
            $edit_query = $productManager->getProductById($edit_id);
